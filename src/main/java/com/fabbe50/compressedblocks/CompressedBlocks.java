...
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.VERSION, acceptedMinecraftVersions = "[1.11.2]", dependencies = Dependencies.dependencies, guiFactory = Reference.GUIFACTORY)
