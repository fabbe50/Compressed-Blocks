...
public class BlockBrewer extends BlockContainer {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (worldIn.isRemote) {
            ...
            if (tileentity instanceof TileEntityBrewer) {
                playerIn.displayGUIChest((TileEntityBrewer)tileentity);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        if (stack.hasDisplayName()) {
            ...
            if (tileentity instanceof TileEntityBrewer) {
                ((TileEntityBrewer)tileentity).setName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (tileentity instanceof TileEntityBrewer) {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityBrewer) tileentity);
        }
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockRegistry.BREWER);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(BlockRegistry.BREWER);
    }
