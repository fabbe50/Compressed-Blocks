...
public class BlockMiningExplosives extends BlockBase {
    ...
    private List<Block> getOres() {
        ...
        if (Loader.isModLoaded("actuallyadditions")) {
            ores.add(Block.getBlockFromItem(new ItemStack(ModItemRegistry.BLACK_QUARTZ, 1, 3).getItem()));
        }
        if (Loader.isModLoaded("appliedenergistics2")) {
            ores.add(ModItemRegistry.AE2_QUARTZ_ORE);
            ores.add(ModItemRegistry.AE2_CHARGED_QUARTZ_ORE);
        }
