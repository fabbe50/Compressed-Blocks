 ...
 */
public class EntityCompressedTNT extends Entity{
    private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityCompressedTNT.class, DataSerializers.VARINT);
    private EntityLivingBase fsPlacedBy;
    private int fuse;
    private int strength;

    public EntityCompressedTNT(World worldIn) {
        super(worldIn);
        this.fuse = 20;
    ...
    public EntityCompressedTNT(World worldIn, double x, double y, double z, EntityLivingBase igniter, int strength) {
        this(worldIn);
