...
public class ContainerBrewer extends Container {
    ...
    public ContainerBrewer(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
        this.tileBrewingStand = tileBrewingStandIn;
        this.addSlotToContainer(new ContainerBrewer.Potion(playerInventory.player, tileBrewingStandIn, 0, 56, 51));
        this.addSlotToContainer(new ContainerBrewer.Potion(playerInventory.player, tileBrewingStandIn, 1, 79, 58));
        this.addSlotToContainer(new ContainerBrewer.Potion(playerInventory.player, tileBrewingStandIn, 2, 102, 51));
        this.theSlot = this.addSlotToContainer(new ContainerBrewer.Ingredient(tileBrewingStandIn, 3, 79, 17));
        this.addSlotToContainer(new ContainerBrewer.Fuel(tileBrewingStandIn, 4, 17, 17));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if ((index < 0 || index > 2) && index != 3 && index != 4) {
                ...
                else if (ContainerBrewer.Potion.canHoldPotion(itemstack)) {
                    if (!this.mergeItemStack(itemstack1, 0, 3, false)) {
                        return ItemStack.EMPTY;
                    }
                }
                else if (ContainerBrewer.Fuel.isValidBrewingFuel(itemstack)) {
    ...
    static class Potion extends Slot {
        ...
        public static boolean canHoldPotion(ItemStack stack) {
            return VanillaHooks.isValidInput(stack);
        }
    }
}
