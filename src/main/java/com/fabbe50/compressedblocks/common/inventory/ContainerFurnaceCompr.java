...
/**
 * Created by fabbe50 on 16/07/2016.
 */
public class ContainerFurnaceCompr extends Container {
    ...
    public ContainerFurnaceCompr(InventoryPlayer playerInventory, IInventory furnaceInventory) {
