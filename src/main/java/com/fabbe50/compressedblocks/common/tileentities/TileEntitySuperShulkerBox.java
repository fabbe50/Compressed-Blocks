 ...
 */
public class TileEntitySuperShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
    private static final int[] SLOTS = new int[54];
    private NonNullList<ItemStack> items;
    private boolean hasBeenCleared;
    private int openCount;
    private TileEntitySuperShulkerBox.AnimationStatus animationStatus;
    ...
    public TileEntitySuperShulkerBox(@Nullable EnumDyeColor colorIn) {
        ...
        this.animationStatus = TileEntitySuperShulkerBox.AnimationStatus.CLOSED;
        this.color = colorIn;
    }
    ...
    public void update() {
        ...
        if (this.animationStatus == TileEntitySuperShulkerBox.AnimationStatus.OPENING || this.animationStatus == TileEntitySuperShulkerBox.AnimationStatus.CLOSING) {
        ...
        switch (this.animationStatus) {
            ...
            case OPENING:
                ...
                if (this.progress >= 1.0F) {
                    this.moveCollidedEntities();
                    this.animationStatus = TileEntitySuperShulkerBox.AnimationStatus.OPENED;
                    this.progress = 1.0F;
                }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState p_190584_1_) {
        return this.getBoundingBox((EnumFacing)p_190584_1_.getValue(BlockSuperShulkerBox.FACING));
    }
    ...
    public boolean receiveClientEvent(int id, int type) {
        if (id == 1) {
            ...
            if (type == 0) {
                this.animationStatus = TileEntitySuperShulkerBox.AnimationStatus.CLOSING;
            }

            if (type == 1) {
                this.animationStatus = TileEntitySuperShulkerBox.AnimationStatus.OPENING;
            }
    ...
    public EnumDyeColor getColor() {
        if (this.color == null) {
            this.color = BlockSuperShulkerBox.getColorFromBlock(this.getBlockType());
        }
