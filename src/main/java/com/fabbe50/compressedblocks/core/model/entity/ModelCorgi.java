// Date: 17/09/2016 18:21:33
// Template version 1.1
// Java generated by Techne
// Keep in mind that you still need to fill in some blanks
// - ZeuX

package com.fabbe50.compressedblocks.core.model.entity;
...
public class ModelCorgi extends ModelBase
{
  ...
  public ModelCorgi()
  {
    ...
    textureHeight = 64;
      ...
      LegFrontRight.addBox(0F, 0F, 0F, 2, 4, 2);
      ...
      LegBackLeft.addBox(0F, 0F, 0F, 2, 4, 2);
      ...
      LegBackRight.addBox(0F, 0F, 0F, 2, 4, 2);
      ...
      EarRight.addBox(-3F, -6F, 0.5F, 2, 3, 1);
      ...
      MouthUpper.addBox(-1.5F, -0.5F, -4.5F, 3, 2, 3);
      ...
      MouthLower.addBox(-1.5F, 1.5F, -4.5F, 3, 1, 3);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    {
        EntityCorgi entitycorgi = (EntityCorgi)entitylivingbaseIn;
        ...
        else
        {
            ...
            this.LegFrontRight.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
            this.LegFrontRight.rotateAngleY = 0;
            this.LegFrontLeft.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
            this.LegFrontLeft.rotateAngleY = 0;
            this.LegBackRight.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
            this.LegBackRight.rotateAngleY = 0;
            this.LegBackLeft.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
