...
public class Textures {
    ...
    public static final String corgiDir = "compressedblocks/entity/corgi";
    ...
    private static void getCorgiTextureNames() {
        ...
        try {
            if (dir.exists()) {
                ...
                LogHelper.warn("Couldn't find the \"compressedblocks/entity/corgi\" directory!");
                if (dir.mkdirs()) {
                    LogHelper.info("Created \"compressedblocks/entity/corgi\" directory.");
                    if (textureDir.mkdir()) { LogHelper.info("Created \"compressedblocks/entity/corgi/textures\" directory."); }
                    if (configDir.mkdir()) { LogHelper.info("Created \"compressedblocks/entity/corgi/config\" directory."); }
                }
                else {
                    LogHelper.warn("Failed to create \"compressedblocks/entity/corgi\" directory. If you intend to use this, you might wanna create it yourself.");
                }
            }
        }
        catch (Exception e) {
