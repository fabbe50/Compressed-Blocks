...
public class ItemRegistry {
    ...
    public static final Item SING_PICKAXE;
    ...
    static {
        ...
        SING_PICKAXE = TFIItems.registerItem(new ItemSingularityPickaxe("singularitypick"));
    }
    ...
    public static void renderInit() {
        ...
        ItemRenderer.registerItem(SING_PICKAXE);
    }
