...
public class TileEntityBeaconXrayRenderer extends TileEntitySpecialRenderer<TileEntityBeaconXray>
{
    ...
    public void renderBeacon(double p_188206_1_, double p_188206_3_, double p_188206_5_, double p_188206_7_, double p_188206_9_, List<TileEntityBeaconXray.BeamSegment> p_188206_11_, double p_188206_12_)
    {
        ...
        if (p_188206_9_ > 0.0D)
        {
            ...
            {
                TileEntityBeaconXray.BeamSegment tileentitybeacon$beamsegment = (TileEntityBeaconXray.BeamSegment)p_188206_11_.get(j);
    ...
    public boolean isGlobalRenderer(TileEntityBeaconXray te)
    {
        return true;
    }
}
