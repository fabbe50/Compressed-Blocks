...
public class EntityCorgi extends EntityTameable {
    ...
    /**
     * Used when calculating the amount of shading to apply while the corgi is shaking.
     */
    @SideOnly(Side.CLIENT)
    ...
    /**
     * Determines whether this corgi is angry or not.
     */
    ...
    /**
     * Sets whether this corgi is angry or not.
     */
    ...
    /**
     * Return this corgi's collar color.
     */
