...
public class BeaconCraftingRecipeWrapper extends BlankRecipeWrapper implements IRecipeWrapper {
    private final IJeiHelpers jeiHelpers;
    private final MiniBeaconRecipes recipe;

    public BeaconCraftingRecipeWrapper(IJeiHelpers jeiHelpers, MiniBeaconRecipes recipe) {
