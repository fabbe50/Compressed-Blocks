...
public class ReturnCraftingCategory extends BlankRecipeCategory<IRecipeWrapper> {
    ...
    public ReturnCraftingCategory(IGuiHelper guiHelper) {
        ResourceLocation location = Constants.RECIPE_GUI_VANILLA;
        this.background = guiHelper.createDrawable(location, 0, 60, 116, 54);
        this.localizedName = Translator.translateToLocal("gui.jei.category.returnCrafting");
        this.craftingGridHelper = guiHelper.createCraftingGridHelper(1, 0);
    }

    @Override
    public String getUid() {
        return "compressedblocks.returncrafting";
    }
